...
mixin _$CategoryScreenState {
 ...
 ProjectType? get selectedType; EnumCategoryProjectType? get projectFilter; List<CategoryItemModel> get projects; AsyncValue<List<CategoryItemModel>> get projectState;
...
@useResult
$Res call({
 ProjectType? selectedType, EnumCategoryProjectType? projectFilter, List<CategoryItemModel> projects, AsyncValue<List<CategoryItemModel>> projectState
});
...
/// Create a copy of CategoryScreenState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? selectedType = freezed,Object? projectFilter = freezed,Object? projects = null,Object? projectState = null,}) {
...
as List<CategoryItemModel>,projectState: null == projectState ? _self.projectState : projectState // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( ProjectType? selectedType,  EnumCategoryProjectType? projectFilter,  List<CategoryItemModel> projects,  AsyncValue<List<CategoryItemModel>> projectState)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CategoryScreenState() when $default != null:
return $default(_that.selectedType,_that.projectFilter,_that.projects,_that.projectState);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( ProjectType? selectedType,  EnumCategoryProjectType? projectFilter,  List<CategoryItemModel> projects,  AsyncValue<List<CategoryItemModel>> projectState)  $default,) {final _that = this;
switch (_that) {
case _CategoryScreenState():
return $default(_that.selectedType,_that.projectFilter,_that.projects,_that.projectState);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( ProjectType? selectedType,  EnumCategoryProjectType? projectFilter,  List<CategoryItemModel> projects,  AsyncValue<List<CategoryItemModel>> projectState)?  $default,) {final _that = this;
switch (_that) {
case _CategoryScreenState() when $default != null:
return $default(_that.selectedType,_that.projectFilter,_that.projects,_that.projectState);case _:
  return null;
...
class _CategoryScreenState implements CategoryScreenState {
   _CategoryScreenState({this.selectedType, this.projectFilter = EnumCategoryProjectType.recommend, final  List<CategoryItemModel> projects = const [], this.projectState = const AsyncValue.loading()}): _projects = projects;
...
@override@JsonKey() final  AsyncValue<List<CategoryItemModel>> projectState;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _CategoryScreenState&&(identical(other.selectedType, selectedType) || other.selectedType == selectedType)&&(identical(other.projectFilter, projectFilter) || other.projectFilter == projectFilter)&&const DeepCollectionEquality().equals(other._projects, _projects)&&(identical(other.projectState, projectState) || other.projectState == projectState));
}


@override
int get hashCode => Object.hash(runtimeType,selectedType,projectFilter,const DeepCollectionEquality().hash(_projects),projectState);
...
/// Create a copy of CategoryScreenState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? selectedType = freezed,Object? projectFilter = freezed,Object? projects = null,Object? projectState = null,}) {
