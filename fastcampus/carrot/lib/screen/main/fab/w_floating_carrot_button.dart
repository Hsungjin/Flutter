            ...
            children: [
              ...
              Tap(
                ...
                child: AnimatedContainer(
                  ...
                  isExpanded ? context.appColors.floatingActionLayer : Color(0xffff791f), borderRadius: BorderRadius.circular(30)),
                  child: Row(
                    mainAxisSize: MainAxisSize.min,
                    children: [
                      AnimatedRotation(turns: isExpanded ? 0.125 : 0, duration: duration, child: const Icon(Icons.add, color: Colors.white)),
                      AnimatedWidthCollapse(visible: !isSmall, child: '글쓰기'.text.make(), duration: duration),
                    ],
                  ),
