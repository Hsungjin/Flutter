import 'package:bloc_to_communication_sample/src/app.dart';
    ...
    return MaterialApp(
      ...
      home: MultiRepositoryProvider(
        ...
        child: MultiBlocProvider(
          providers: [
            BlocProvider(create: (context) => ProductBloc(context.read<ProductRepository>(), context.read<LicenseRepository>())),
            BlocProvider(create: (context) => LicenseBloc(context.read<LicenseRepository>())),
          ],
          child: const App(),
        ),
        // child: BlocProvider(
